...
======> Add your input to `inputs` folder as `pb_2_input`
"""
...
def get_game_value(line: str) -> int:
    """
    Returns game id if game is valid, else returns 0
...
def cube_games_result(aoc_input: str) -> int:
    """
    ...
    """
    result = 0
    with open(aoc_input) as reader:
        for line in reader:
            result += get_game_value(line)
    return result


# Part 1
print(f"Solution to DAY 2, Part 1: {cube_games_result('inputs/pb_2_input')}")
...
# Part 2
def get_min_game_value(line: str) -> int:
    """
    Returns game id if game is valid, else returns 0
...
def cube_games_result2(aoc_input: str) -> int:
    """
    ...
    with open(aoc_input) as reader:
        for line in reader:
            result += get_min_game_value(line)
    return result

# Part 2
print(f"Solution to DAY 2, Part 2: {cube_games_result2('inputs/pb_2_input')}")
